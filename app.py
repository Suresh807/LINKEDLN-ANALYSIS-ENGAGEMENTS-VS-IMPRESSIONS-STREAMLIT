...
def main_page():
    ...
    st.sidebar.markdown("**Created by Suresh Kumar K**")
...
def page2():
    st.write("# LinkedIn Engagement Analysis - Impression VS Engagements")
    # sidebar
...
def page3():
    ...
    linkedin_button = '<a href="https://www.linkedin.com/in/suresh-kumar-k-398439237/" target="_blank" style="text-align: center; margin: 0px 10px; padding: 5px 10px; border-radius: 5px; color: white; background-color: #0077B5; text-decoration: none">LinkedIn</a>'
    github_button = '<a href="https://github.com/Suresh807" target="_blank" style="text-align: center; margin: 0px 10px; padding: 5px 10px; border-radius: 5px; color: white; background-color: #24292E; text-decoration: none">GitHub</a>'
